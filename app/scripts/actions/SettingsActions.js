...
export const SET_SERVER_METHOD     = "SET_SERVER_METHOD";
...
export const setServerMethodAction    = createAction(SET_SERVER_METHOD);
...
export function setServerMethod(method) {
	return setServerMethodAction({method});
}
...
export const updateBackgroundServer = (server) => {
	const message = {
		type: "SERVER",
